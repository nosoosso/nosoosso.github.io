...
/***/ function(module, exports, __webpack_require__) {
	...
	var SnakeGame = __webpack_require__(157);
	...
	window.App = {
	    render: function render() {
	        ...
	        React.render(React.createElement(SnakeGame, null), document.getElementById('snake-game'));
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameStore = __webpack_require__(178);
	var Action = __webpack_require__(181);
	
	var Board = __webpack_require__(183);
	...
	var SnakeGame = React.createClass({
	    ...
	    render: function render() {
	        ...
	        } else if (this.state.gameStore.scene === 'title') {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(Board, { board: this.state.gameStore.board, item: this.state.gameStore.item })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.connect = __webpack_require__(173);
	
	Reflux.connectFilter = __webpack_require__(175);
	
	Reflux.ListenerMixin = __webpack_require__(174);
	
	Reflux.listenTo = __webpack_require__(176);
	
	Reflux.listenToMany = __webpack_require__(177);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Reflux.ActionMethods = __webpack_require__(160);
	
	Reflux.ListenerMethods = __webpack_require__(161);
	
	Reflux.PublisherMethods = __webpack_require__(171);
	
	Reflux.StoreMethods = __webpack_require__(170);
	
	Reflux.createAction = __webpack_require__(172);
	
	Reflux.createStore = __webpack_require__(166);
	
	var maker = __webpack_require__(165).staticJoinCreator;
	...
	var _ = Reflux.utils = __webpack_require__(162);
	...
	Reflux.__keep = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(162),
	    maker = __webpack_require__(165).instanceJoinCreator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EventEmitter = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createStore = __webpack_require__(166),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(162),
	    Keep = __webpack_require__(167),
	    mixer = __webpack_require__(168),
	    bindMethods = __webpack_require__(169);
	...
	module.exports = function (definition) {
	    ...
	    var StoreMethods = __webpack_require__(170),
	        PublisherMethods = __webpack_require__(171),
	        ListenerMethods = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(162),
	    ActionMethods = __webpack_require__(160),
	    PublisherMethods = __webpack_require__(171),
	    Keep = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ListenerMethods = __webpack_require__(161),
	    ListenerMixin = __webpack_require__(174),
	    _ = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TimeStore = __webpack_require__(180);
	var Action = __webpack_require__(181);
	...
	var GameStore = Reflux.createStore({
	    ...
	    onKeyPress: function onKeyPress(key) {
	        ...
	        var prevDirection = this.data.snake.prevDirection;
	        // can't move against previous direction
	        if (prevDirection === 'right' && direction === 'left' || prevDirection === 'left' && direction === 'right' || prevDirection === 'up' && direction === 'down' || prevDirection === 'down' && direction === 'up') {
	            return;
	        }
	    ...
	    initializeGame: function initializeGame() {
	        ...
	        var row = List.of();
	        for (var i = 0; i < co.boardSize.x; i++) {
	            row = row.push(0);
	        }
	        for (var i = 0; i < co.boardSize.y; i++) {
	            this.data.board = this.data.board.push(row);
	        }
	
	        // put item
	        this.data.item = Map({
	            x: Math.floor(Math.random() * (co.boardSize.x - 1)),
	            y: Math.floor(Math.random() * (co.boardSize.y - 1))
	        });
	
	        // set initial position
	        var initialPosX = Math.floor(co.boardSize.x / 3);
	        var initialPosY = Math.floor(co.boardSize.y / 2);
	        this.data.board = this.data.board.set(initialPosY, this.data.board.get(initialPosY).set(initialPosX, length + 1));
	    ...
	    update: function update() {
	        ...
	        var currentHead = this.data.snake.head;
	        // move head
	        ...
	        var snakeHead = this.data.snake.head;
	
	        if (snakeHead.get('x') < 0 || snakeHead.get('y') < 0 || snakeHead.get('x') >= co.boardSize.x || snakeHead.get('y') >= co.boardSize.y || this.data.board.get(snakeHead.get('y')).get(snakeHead.get('x')) > 1) {
	            this.data.scene = 'dead';
	            return;
	        }
	
	        this.data.board = this.data.board.set(snakeHead.get('y'), this.data.board.get(snakeHead.get('y')).set(snakeHead.get('x'), this.data.snake.length + 1));
	        ...
	        if (snakeHead.get('x') === item.get('x') && snakeHead.get('y') === item.get('y')) {
	            ...
	            this.data.board = this.data.board.map(function (row) {
	                return row.map(function (cell) {
	                    if (cell > 0) return cell - 1;else return cell;
	                });
	            });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = Reflux.createActions(['tick', 'pageLoad', 'keyPress']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = React.createClass({
	    ...
	    getRows: function getRows() {
	        var rows = List.of();
	        for (var i = 0; i < co.boardSize.y; i++) {
	            rows = rows.push(React.createElement(Row, { board: this.props.board, item: this.props.item, key: i, y: i }));
	        }
	        return rows;
	    },
	    render: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cell = __webpack_require__(185);
	var co = __webpack_require__(182);
	...
	var Row = React.createClass({
	    ...
	    getCells: function getCells() {
	        ...
	        for (var i = 0; i < co.boardSize.x; i++) {
	            ...
	            if (this.props.board.get(this.props.y).get(i) > 0) {
	                onSnake = true;
	            } else if (i === this.props.item.get('x') && this.props.y === this.props.item.get('y')) {
	                onItem = true;
	            }
	
	            cells = cells.push(React.createElement(Cell, { key: i, onSnake: onSnake, onItem: onItem }));
	        }
	        return cells;
	    },
	    render: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cell = React.createClass({
	    ...
	    propTypes: {
	        onSnake: React.PropTypes.bool.isRequired,
	        onItem: React.PropTypes.bool.isRequired
	    },
	    render: function render() {
	        if (this.props.onSnake === true) {
	            return React.createElement("td", { className: "snake" });
	        } else if (this.props.onItem === true) {
	            return React.createElement("td", { className: "item" });
	        }
	        return React.createElement("td", { className: "cell" });
	    }
	});
