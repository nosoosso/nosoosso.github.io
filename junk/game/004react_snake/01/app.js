	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                null,
	                this.state.gameStore.snake.body
	            ),
	            React.createElement(Board, { snake: this.state.gameStore.snake.body })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameStore = Reflux.createStore({
	    ...
	    init: function init() {
	        ...
	        this.data.snake.body = List.of(List.of(co.boardSize.x / 2, co.boardSize.y / 2));
	        // put item
	        this.data.item = [Math.floor(Math.random() * (co.boardSize.x - 1)), Math.floor(Math.random() * (co.boardSize.y - 1))];
	    },
	    updateSnake: function updateSnake() {
	        ...
	        switch (this.data.snake.direction) {
	            case 'right':
	                currentPos = this.data.snake.body.first();
	        ...
	        this.data.snake.body = this.data.snake.body.unshift(nextPos);
	        this.data.snake.body = this.data.snake.body.pop();
	...
	var Board = React.createClass({
	    ...
	    getRows: function getRows() {
	        ...
	        for (var i = 0; i < co.boardSize.y; i++) {
	            rows = rows.push(React.createElement(Row, { snake: this.props.snake, key: i, y: i }));
	        }
	        return rows;
	    },
	    render: function render() {
	...
	var Row = React.createClass({
	    ...
	    getCells: function getCells() {
	        ...
	        for (var i = 0; i < co.boardSize.x; i++) {
	            var onSnake = false;
	            if (this.props.snake.includes(List.of(i, this.props.y))) {
	                onSnake = true;
	            }
	            cells = cells.push(React.createElement(Cell, { snake: this.props.snake, key: i, onSnake: onSnake }));
	        }
	        return cells;
	    },
	    render: function render() {
